...
chats = {}
plugins = {}
MaTaDoR_sudo = 138742222 --> اینجا آیدی سودو اصلی رو جایگزین کنید
GpsidSudo = -1001253895899 --> اینجا آیدی پیوی یا گروه یا حتی چنل مورد نظرتونو جایگزین کنید تا هرجا ربات نصب میشه پیام اطلاع رسانی نصب در گروه جدید رو اینجا بده
bot_id =  466588282 --> جایگزین کنید cli اینجام که آیدی ربات
helper_id =  447686098--> جایگزین کنید api آیدی ربات
MaTaDoRch = '@FoX_Tm' --> یوزرنیم کانالتونو جایگزین کنید
MaTaDoRby = '@o1o2o3o4o' --> یوزرنیم خودتونو جایگزین کنید
MaTaDoRbybot = '@c1bot'  --> اگه پیام رسان دارید یوزرنیم پیام رسانتو جایگزین کنید 
paypinglink = 'mosazade1' --> یوزرنیم درگاه پرداخت پی پینگ هم اگه دارین وارد کنید
paypingname = 'میر محمد موسی زاده' --> اسم یا لقبی که می خواین لینک بشه به درگاه پرداخت رو وارد کنید
...
sudo_users = {138742222,466588282,447686098}, --> رو جایگزین کنید api و cli داخل آکولاد آیدی سودو اصلی و سودوهای دیگه (درصورت نیاز) و آیدی ربات
    admins = {},
    disabled_channels = {},
